    ...
    <div class="list">
      <ul class="swiper-wrapper">
        <li class="swiper-slide">
          ...
          <a href="">네오포레<span class="material-icons"> east </span></a>
        </li>
        <li class="swiper-slide">
      ...
      <ul>
        <li>
          <a href="">
            ...
            <div class="btn">문의하기<span class="material-icons"> east</span></div>
          </a>
        </li>
        <li>
          <a href="">
            ...
            <div class="btn">정보확인<span class="material-icons"> east</span></div>
          </a>
        </li>
      </ul>
    </div>
